...
$APPLICATION->SetTitle("Анкета для суррогатных матерей");?>
<?
$form = array();
...
$form[] = Array("NAME" => "Национальность", "CODE" => "NAZIONAL", "CLEAR" => "N", "TYPE" => "text", "REQUIRED" => "Y", "DATA_MASK" => "N");
$form[] = Array("NAME" => "Образование", "CODE" => "OBRAZOV", "CLEAR" => "N", "TYPE" => "text", "REQUIRED" => "Y", "DATA_MASK" => "N");
$form[] = Array("NAME" => "Профессия", "CODE" => "PROFESSIYA", "CLEAR" => "N", "TYPE" => "text", "REQUIRED" => "Y", "DATA_MASK" => "N");
$form[] = Array("NAME" => "Семейное положение", "CODE" => "SEM_POLOJ", "TYPE" => "select", "REQUIRED" => "Y", "OPTIONS" => Array("Не выбрано", "Не замужем", "Замужем", "Разведена", "Другое"));
$form[] = Array("NAME" => "Сколько беременностей и чем закончились: роды в срок; преждевременные; аборт; внематочная; выкидыш?", "CODE" => "SKOLKO_BEREMENOSTEY", "CLEAR" => "Y", "TYPE" => "textarea", "REQUIRED" => "N");
$form[] = Array("NAME" => "В каком году были последние роды в срок?", "CODE" => "GOD_BEREMENOSTI", "CLEAR" => "N", "TYPE" => "text", "REQUIRED" => "N", "DATA_MASK" => "N");
$form[] = Array("NAME" => "Сколько у вас детей?", "CODE" => "SKOLKO_DETEY", "CLEAR" => "N", "TYPE" => "text", "REQUIRED" => "Y", "DATA_MASK" => "N");
$form[] = Array("NAME" => "Cколько длилось грудное вскармливание вашего ребенка?", "CODE" => "DLITELNOST_VSKARMLIV", "CLEAR" => "Y", "TYPE" => "textarea", "REQUIRED" => "N");
$form[] = Array("NAME" => "Применяли ли Вы когда-либо ВМС (внутриматочную спираль)?", "CODE" => "VMS", "TYPE" => "select", "REQUIRED" => "Y", "OPTIONS" => Array("Нет", "Да"));
$form[] = Array("NAME" => "Применяли ли Вы когда-либо КОК (комбинированные оральные контрацептивы)?", "CODE" => "KOK", "TYPE" => "select", "REQUIRED" => "Y", "OPTIONS" => Array("Нет", "Да"));
$form[] = Array("NAME" => "Дата начала последних месячных", "CODE" => "DATA_MESYACHNIH", "CLEAR" => "N", "TYPE" => "text", "REQUIRED" => "N", "DATA_MASK" => "N");
...
$form[] = Array("NAME" => "Ваша группа крови", "CODE" => "GRUPPA_KROVI", "TYPE" => "select", "REQUIRED" => "N", "OPTIONS" => Array("Не выбрано", "I", "II", "III", "IV"));
$form[] = Array("NAME" => "Ваш резус-фактор", "CODE" => "REZUC_FACTOR", "TYPE" => "select", "REQUIRED" => "N", "OPTIONS" => Array("Не выбрано", "+", "-"));
