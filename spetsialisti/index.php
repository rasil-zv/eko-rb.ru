...
$APPLICATION->SetPageProperty("title", "Специалисты клиники в Уфе и Стерлитамаке «Здоровье женщины и мужчины»");
$APPLICATION->SetTitle("Специалисты клиник «Здоровье женщины и мужчины»");
