...
?>
<div class="reviews_page reset">
    <h2 class="reviews_page_title">
        Оставить отзыв
    </h2>
    <form id="reviews_form">
        ...
        <div class="form row no-gutters">
            ...
            <div class="column col-lg-6">
                <div class="textarea">
                    <textarea name="review" rows="5" placeholder="Ваш отзыв *" required></textarea>
                </div>
                <div class="check">
                    <input class="styler" type="checkbox" id="reviews_check" checked="checked" required>
                    <label for="reviews_check">
            ...
            <div class="button col-lg-12">
                <input type="submit" class="btn purple" value="Оставить отзыв">
            </div>
        </div>
        <div class="result" id="reviews_result"></div>
    </form>
