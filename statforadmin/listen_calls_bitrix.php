...
$sourse=74997094394;
    ...
    if(strcmp($crm_type, 'BITRIX')==0){
        ...
        'fields' => array(
          'TITLE' => 'Новая заявка с сайта fors-tsk.ru -'.$_REQUEST['tema'],
          'NAME' =>  $_REQUEST['name'],
		  "STATUS_ID" => "NEW",
		  "ASSIGNED_BY_ID" => 522,
		  "SOURCE_ID" => $sourse,
		  "PHONE" => array(array("VALUE" => $_REQUEST['tel'], "VALUE_TYPE" => "WORK" )),
		  "EMAIL" => array(array("VALUE" => $_REQUEST['mail'], "VALUE_TYPE" => "WORK" )),
		  'COMMENTS' => $_REQUEST['komm'],
