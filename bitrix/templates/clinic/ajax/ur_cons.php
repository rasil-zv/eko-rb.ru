...
if (($check_2 == 'check') && ($check == '')){
    ...
    /**/
    $to = $GLOBALS["wc_mail"];
    $subject = 'Здоровье женщины и мужчины - новый вопрос юристу.';
    $message = '
        <html>
            <head>
                <title>'.$subject.'</title>
            ...
            <body>
                <p>На вашем сайте "Здоровье женщины и мужчины" была заполнена форма консультации юриста, с данными отправителя вы можете ознакомиться ниже:</p>
                <p>Имя: '.$name.'</p>
                <p>Телефон: '.$phone.'</p>
                <p>E-Mail: '.$email.'</p>
                <p>Вопрос: '.$question.'</p>
                <p>Ответить на вопрос вы можете через панель администратора в разделе Консультация Юриста.</p>
            </body>
        </html>';
